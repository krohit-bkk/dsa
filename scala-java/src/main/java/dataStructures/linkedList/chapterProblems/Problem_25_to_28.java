...
public class Problem_25_to_28 {

    // Problem 26: Scanning twice
    // Time  complexity: O[N]
    ...
    // Problem 28: Most efficient - two pointers
    // Time  complexity: O[N]
    // Space complexity: O[1]
    private static void problem_28_print_middle_nodes(ListNode head) {
        // Sanity check
        if(head == null){
            System.out.println("ERROR: Empty list!");
            return;
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Problem 25: Find middle of LinkedList using brute force
        ...
        // Problem 28: Most efficient - using two pointer approach
        ...
        System.out.println();
        problem_28_print_middle_nodes(evenList);
        problem_28_print_middle_nodes(oddList);
    }
}
